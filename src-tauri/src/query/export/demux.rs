...
use arrow_schema;
use datafusion::arrow::array::{AsArray, StringArray, StructArray, UInt64Builder};
use datafusion::arrow::datatypes::{DataType, Schema};
use datafusion::arrow::{self, downcast_dictionary_array};
use datafusion::common::cast::as_string_array;
use datafusion::common::exec_datafusion_err;
use datafusion::common::runtime::SpawnedTask;
use datafusion::execution::TaskContext;
use datafusion::{arrow::array::RecordBatch, datasource::listing::ListingTableUrl};
...
fn remove_partition_by_columns(
    ...
    let final_batch_to_send = RecordBatch::try_new(Arc::new(non_part_schema), non_part_cols)?;
